...
add = [ b'add', b'add.w', b'adds', b'adds.w', b'vadd.f32' ]
...
vmlas = [ b'vmla.f32', b'vmls.f32', b'vnmls.f32', b'mla', b'mla.n', b'mla.w', b'mls', b'mls.w', b'mls.n' ]
...
move = [ b'mov', b'movw', b'movs', b'movs.w',  b'vmov.f32', b'mov.w', b'vmov', b'vmrs', b'mvn', b'mvn.w']
